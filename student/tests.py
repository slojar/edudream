...
class TestStudentTestCase(TestCase):
    def setUp(self):
        ...
        Wallet.objects.create(user=parent_user, balance=20.0)
        # Create Tutor User
        ...
        TutorCalendar.objects.create(user=tutor_user, day_of_the_week=1, time_from="09:00:00", time_to="12:00:00")
        # Create Student Model
        student = Student.objects.create(user=student_user, parent=parent_)
        # Create Subject
        subject = Subject.objects.create(name="Mathematics", grade="high_school", amount=2.0)
    ...
    def test_create_class(self):
        ...
        data = {
            ...
            "tutor_id": 3,
            "student_id": 1,
            "start_date": "2024-02-26T09:00:00",
            "end_date": "2024-02-26T09:20:00",
            "subject_id": 1,
            "book_now": False
        }
