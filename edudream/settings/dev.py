...
# GOOGLE CALENDAR API
GOOGLE_REDIRECT_URL = env('GOOGLE_REDIRECT_URL', None)
CALENDAR_ID = env('CALENDAR_ID', None)

APP_NAME = env("APP_NAME", None)
COMPANY_ENQUIRY_EMAIL = env("COMPANY_ENQUIRY_EMAIL", None)
CLASSROOM_GRACE_PERIOD = env("CLASSROOM_GRACE_PERIOD", None)
